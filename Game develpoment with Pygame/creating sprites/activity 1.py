...
# Colors
BG_COLORS = [pygame.Color('blue'), pygame.Color('pink'), pygame.Color('red')]
SPRITE_COLORS = [pygame.Color('yellow'), pygame.Color('magenta'), pygame.Color('orange'), pygame.Color('black')]
