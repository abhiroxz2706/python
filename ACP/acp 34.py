...
# Player
playerImg = pygame.image.load('space_rocket.png')
...
for _i in range(num_of_enemies):
    img = pygame.transform.scale( pygame.image.load('alien.png'), (50, 50))
    enemyImg.append(img)
...
while running:
    ...
    playerX = max(0, min(playerX, SCREEN_WIDTH - 150))  # 64 is the size of the player
